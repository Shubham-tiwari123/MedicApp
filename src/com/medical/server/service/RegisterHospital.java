...
public class RegisterHospital implements RegisterHospitalInterface{
    ...
    @Override
    public SetKeys generateKey() throws Exception{
    ...
    @Override
    public boolean saveClientKey(String pubMod,String pubExpo,String username) throws Exception{
