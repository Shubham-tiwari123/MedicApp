...
public class DatabaseHospital implements DatabaseHospitalInterface {
    ...
    @Override
    public boolean verifyUsername(String userName, String collectionName) throws Exception {
        if (createDbConn()) {
    ...
    @Override
    public boolean storeServerKey(SetKeys keys, String collectionName) throws Exception {
        if (createDbConn()) {
            if (checkCollection(collectionName)) {
                collection = database.getCollection(collectionName);
    ...
    @Override
    public SetKeys getServerKeys(String collectionName) throws Exception {
    ...
    @Override
    public boolean storeClientKeys(String pubMod, String pubExpo, String userName,
    ...
    @Override
    public boolean deleteHospital(String userName, String collectionName) throws Exception {
        if (createDbConn()) {
            if (checkCollection(collectionName)) {
